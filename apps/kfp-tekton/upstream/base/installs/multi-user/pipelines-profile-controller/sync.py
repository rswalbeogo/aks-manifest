...
def get_settings_from_env(controller_port=None,
    ...
    to enable backwards compatibility with previous versions of this script:
        visualization_server_image: akskubeflow.azurecr.io/ml-pipeline/visualization-server
        visualization_server_tag: value of KFP_VERSION environment variable
        frontend_image: akskubeflow.azurecr.io/ml-pipeline/frontend
    ...
    settings["frontend_image"] = \
        frontend_image or \
        os.environ.get("FRONTEND_IMAGE", "akskubeflow.azurecr.io/ml-pipeline/frontend")
